...
// (51) 给 abstractAliases 属性赋值
    ...
    protected function resolve($abstract, $parameters = [])
    {
        ...
        // ★核心一★：检测之前是否解析过对应的对象，有则返回对应对象；一种缓存机制
...
// 获取 concrete 类的构造方法  通过反射api 获取依赖
...
// 根据参数的类型约束，注入依赖
     ...
     * 解析ReflectionParameters中的所有依赖项
     * @param  array  $dependencies
     * @return array
     */
    protected function resolveDependencies(array $dependencies)
    {
        // 解析出要类构造方法中的约束类，通过多次 make 自动获取所依赖的对象，
        // 然后通过反射类的 newInstanceArgs 实例化
        $results = [];
